...
class TitleManager:
  ...
  _titles: list[_types.Title] = db.EmbeddedDocumentListField(document_type=_types.Title, default=list)
  _plurals: list[_types.Title] = db.EmbeddedDocumentListField(document_type=_types.Title, default=list)
...
class PosterManager:
  _posters: list[_types.Poster] = db.EmbeddedDocumentListField(document_type=_types.Poster, default=list)
...
class DescriptionManager:
  _descriptions: list[_types.Description] = db.EmbeddedDocumentListField(document_type=_types.Description, default=list)
